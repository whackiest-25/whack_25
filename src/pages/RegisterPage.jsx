      ...
      >
        <div className="p-[2px] bg-gradient-to-br from-neonBlue to-purple-600 rounded-2xl shadow-[0_0_50px_rgba(0,240,255,0.2)]">
          <div className="bg-[#0a0a16] backdrop-blur-xl rounded-2xl p-8 md:p-12 text-center shadow-2xl relative overflow-hidden">
            ...
            {!isOnboarding ? (
              <>
                <h2 className="text-3xl font-black mb-2 text-white tracking-tighter uppercase">
                  Mission Access
                </h2>
                <p className="text-neonBlue mb-8 text-xs font-mono tracking-[0.3em] uppercase">
                  Identify Yourself
                </p>
              ...
              <form onSubmit={handleOnboardingSubmit} className="space-y-6 text-left">
                ...
                <div>
                  <label className="block text-techGreen text-xs font-bold mb-2 uppercase tracking-wider">
                    Call Sign (Nickname)
                  </label>
                  <input
                    type="text"
                ...
                <div className="flex space-x-4">
                  ...
                  <div className="flex-2">{/* Spacer or extra field */}</div>
                </div>
