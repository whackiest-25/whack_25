...
const ScrollSection1 = () => {
    return (
        <section id="about" className="relative min-h-screen py-20 bg-spaceBlue overflow-hidden flex items-center justify-center">
            ...
            <div className="container mx-auto px-6 relative z-10 text-center">
                ...
                >
                    <p className="text-xl md:text-3xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
                        ...
                        Simulate <span className="text-neonBlue font-semibold">real ISRO missions</span> with physical accuracy.
                    </p>
                </motion.div>
